        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="FrontController" method="POST">
                    <input type="text"  name="email" title="Digite o email." placeholder="email" required="required" class="form-control input-lg">
                    <br/>
                    <input type="hidden" value="Email" name="ctrl">
                    <input type="submit" value="Enviar email" class="btn btn-default btn-lg center-block">
                </form>
                <br/>
